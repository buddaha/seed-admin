# seed-admin
seed mall admin 4 backend 
# seed-admin # seed-admin
后台管理界面[Demo](https://www.plantme.cn)用户名/密码：seedadmin/12345678
...
克隆文件：
```
git clone git@github.com:plantme/seed-admin.git
cd seed-admin
```
...
有任何意见或建议都欢迎提 issue  dev@plantme.cn
